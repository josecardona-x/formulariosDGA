...
public class AFPAService {
    ...
    private Person loadAFPAAuxiliares(String document, CatTypeafpa catTypeAfpa) {
        ...
        try {
             ...
             * Author: Ronald Ortiz 
             * Date: 15-10-2024 
             * Description: Se extrae DUI
             * y NIT de la respuesta del servicio DGII para realizar busqueda de
             * informacion usuarios AFPA en BD de Auxiliares de la función
             * pública
             *
             */
            String nitDgii = "", duiDgii = "";
            
            //Se invoca servicio DGII
            UsuarioDGIIResponse dgii = new UsuarioDGIIResponse();
            dgii = clientDgii.uTIL0010(document);
            nitDgii = dgii.getData().getsNit();
            duiDgii = dgii.getData().getsDui();
            ...
            String sqlJust
                    ...
                    + " WHERE  AU.VERSION = 0 and (AU.aux_nit = ? OR AU.aux_nit = ?) and AU.estado = 'ACTIVO'";

            stmt = con.prepareStatement(sqlJust);

            stmt.setString(1, nitDgii);
            stmt.setString(2, duiDgii);
    ...
    private Person loadAFPCourier(String document, CatTypeafpa catTypeAfpa) {
        ...
        try {
            ...
            String sqlJust
                    ...
                    + " WHERE  AU.VERSION = 0 and (AU.NIT = ? OR AU.NIT = ?) and AU.estado = 'ACTIVO'";
    ...
    private Person loadAFPATransportistas(String document, CatTypeafpa catTypeAfpa) {
        ...
        try {
            ...
            String sqlJust
                    ...
                    + " WHERE  AU.SIRT_KEY_VERSION = 0 and (AU.SIRT_NIT = ? OR AU.SIRT_NIT = ?) and AU.SIRT_ESTADO_REG = 'ACTIVO'";
    ...
    private Person loadAFPAAsistente(String document, CatTypeafpa catTypeAfpa) {
        ...
        try {
            ...
            String sqlJust
                    ...
                    + " WHERE  AU.VERSION_DEP = 0 and (AU.AUX_ASIS_NIT = ? OR AU.AUX_ASIS_NIT = ?) and AU.estado = 'ACTIVO'";
